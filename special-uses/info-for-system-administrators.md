...
Audacity is largely accessible. A usage guide can be found in the sidebar; a VPAT document can be found at [audacityteam.org/legal/vpat](https://audacityteam.org/legal/vpat).
