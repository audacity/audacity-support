...
For those who **really have to know**, the list of bugs fixed in 2.2.2 is [here](../../audacity-2.x/audacity-2.2.0/audacity-2.2.2/broken-reference/).
...
See our [list of issues](../../audacity-2.x/audacity-2.2.0/audacity-2.2.2/broken-reference/) for much more detail of issues with Audacity 2.2.2.

* Below are listed what we believe are the most common and important issues with 2.2.2 for most users.

### Accessibility

* Far less of Audacity is properly accessible to visually impaired users than we would like. Currently the best supported platform for accessibility is Windows. We lost a lot of custom accessibility programming when we had to move to a more recent version of the wxWidgets library. A lot more detail about accessibility limitations can be found [here](../../audacity-2.x/audacity-2.2.0/audacity-2.2.2/broken-reference/)
