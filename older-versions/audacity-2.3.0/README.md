...
[Bug 1992](https://bugzilla.audacityteam.org/show_bug.cgi?id=1992) is one way to cause the problem.
{% endhint %}
...
You can choose various combinations of these. However, there are probably too many minor bugs and too much detail on that [dynamic buglist page](../audacity-2.x/audacity-2.3.0/broken-reference/) for most users.
