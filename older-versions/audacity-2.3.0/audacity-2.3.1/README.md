...
You can choose various combinations of these. However, there are probably too many minor bugs and too much detail on that [dynamic buglist page](../../audacity-2.x/audacity-2.3.0/audacity-2.3.1/broken-reference/) for most users.
