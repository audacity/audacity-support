...
You can choose various combinations of these. However, there are probably too many minor bugs and too much detail on that [dynamic buglist page](../../audacity-2.x/audacity-2.4.0/audacity-2.4.2/broken-reference/) for most users.
