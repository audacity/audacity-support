...
![Windows 11 warning when running Audacity installer](../.gitbook/assets/Windows%2011%20-%20Microsoft-verified%20app%20warning.png)
...
![Select the language to use during the installation](../.gitbook/assets/Select%20Setup%20Language.png)

* Once Audacity's Welcome page appears, click the **Next** button.

![Welcome page - Click Next](../.gitbook/assets/Welcome%20Audacity%20Setup.png)
...
![Information page - Links to learn more about Audacity and its license](../.gitbook/assets/Setup%20-%20License.png)
...
![Select the folder to install Audacity](../.gitbook/assets/Setup%20-%20Select%20Destination%20Location.png)
...
![Select if you want to create a shortcut to open Audacity](../.gitbook/assets/Setup%20-%20Additional%20Tasks.png)

* Verify the choices you have made in the Audacity installer and click **Install.**

![Verify your choices and click Install](../.gitbook/assets/Setup%20-%20Ready%20to%20install.png)

* It may take some time to complete the setup process.

![Wait until the setup process completes](../.gitbook/assets/Setup%20-%20Extracting.png)
...
![Click Finish to close the installer](../.gitbook/assets/Setup%20-%20Completed.png)
{% endtab %}
...
*   Once the Audacity application icon appears, drag it into the Applications folder (see below). You will need administrator privileges to accomplish this task. _Do not launch Audacity from the DMG folder._
    ...
    * You may choose to move the Audacity application to any other location.
    ...
    <img src="../.gitbook/assets/Audacity%20Install%20macOS.png" alt="" data-size="original">
...
*   After Audacity has appeared on your screen, press **OK** to start editing! If you do not wish to see the Welcome window again, you may check the "Don't show this again at start up" prompt.
    ...
    <img src="../.gitbook/assets/Mac%20Welcome%20Screen.png" alt="" data-size="original">
{% endtab %}
