...
Macros may be applied to either the entirety of the current project or to a selection of files using the Tools > [Macros...](../../todo/using-macros-to-automate-frequent-tasks/) command.
